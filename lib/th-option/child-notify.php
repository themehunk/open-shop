...
class ThemeHunk_Child_Notify{
	...
	function notify(){
        ...
        <p><?php _e( 'We highly recommended to use child theme. Child theme inherit the style and functionality of parent theme, you can easily update the parent theme without losing its Customization. Thats why we recommended to use child theme to make your site updateproof.', 'open-shop' ); ?></p>
        <a href="<?php echo esc_url('https://themehunk.com/child-theme/#open-shop-child'); ?>" class="button" target="_blank"><?php _e('Get chld theme Now','open-shop') ?></a>
