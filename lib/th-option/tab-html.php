...
<div class="th-option-area">
        ...
        <div class="th-option-bottom-hdr">
            ...
            <a class="tablinks" onclick="openTab(event, 'Recommended-Plugin')"><?php _e('Recommended Plugin','open-shop');?> </a>
            <a class="tablinks" onclick="openTab(event, 'Import-Demo-Content')"><?php _e('Demo Import','open-shop');?> </a>
            <a class="tablinks get-child" onclick="openTab(event, 'Get-Child-Theme')"><?php _e('Get Child Theme','open-shop');?></a>
